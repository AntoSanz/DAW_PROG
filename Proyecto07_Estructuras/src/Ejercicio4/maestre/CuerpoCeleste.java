...
public class CuerpoCeleste implements Serializable {
    ...
    public byte getMaxLengthCodigo() {
        return MAX_LENGTH_CODIGO;
    }

    public byte getMaxLengthNombre() {
        return MAX_LENGTH_NOMBRE;
    }

    public byte getMaxLengthDiametro() {
        return MAX_LENGTH_DIAMETRO;
    }
